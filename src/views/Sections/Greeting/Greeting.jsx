        ...
        <div className="info-panel">
          ...
          <div className="info-body">
            <p className="text-muted" style={{ marginRight: "0px" }}>
              <br />Storyteller, activist, narrative enthusiast, and huge nerd to<br />
              all-things Marvel!<br /><br />
              ...
              From the overgrown, infected world of The Last of Us to the vast<br />
              ...
              tell powerful stories of my own..<br />
